...
3. Ajouter sur le graphe de la question 1 la partition définie par l'abre.
...
On obtient des informations sur la suite de 17 arbres emboités obtenus par l'algorithme d'élagage :

- *CP* représente le paramètre de complexité, plsu il est petit plus l'arbre est grand.
- *nsplit* correspond au nombre de coupures de l'arbre.
- *rel error* contient l'erreur quadratique calculée sur les données d'apprentissage. Cette erreur décroit lorsque la complexité augmente.
- *xerror* contient l'erreur quadratique calculée par validation croisée.
- *xstd* correspond à l'écart type estimé du risque quadratique.
...
On obtient des informations sur la suite de 8 arbres emboités obtenus par l'algorithme d'élagage :

- *CP* représente le paramètre de complexité, plsu il est petit plus l'arbre est grand.
- *nsplit* correspond au nombre de coupures de l'arbre.
- *rel error* contient l'erreur de classification calculée sur les données d'apprentissage. Cette erreur décroit lorsque la complexité augmente.
- *xerror* contient l'erreur de classification calculée par validation croisée.
- *xstd* correspond à l'écart type estimé du risque quadratique.
