...
On considère le jeu de données **phoneme** téléchargeable à l'url [https://github.com/cran/ElemStatLearn/blob/master/data/phoneme.RData](https://github.com/cran/ElemStatLearn/blob/master/data/phoneme.RData).
...
4. Quel peuvent être les intérêts d'effectuer une analyse disciminante régularisée dans ce contexte ? Effectuer une telle analyse à l'aide de la fonction *rda* du package **klaR**.
